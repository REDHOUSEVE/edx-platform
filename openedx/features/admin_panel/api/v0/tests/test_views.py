...
class SiteViewTests(TestCase):
    ...
    def test_return_site_successfully(self):
        ...
        url = reverse('redhouse_features:redhouse_admin_panel:redhouse_admin.api.v0:site', kwargs={'pk': site.id})
    ...
    def test_non_existent_site_return_error(self):
        url = reverse('redhouse_features:redhouse_admin_panel:redhouse_admin.api.v0:site', kwargs={'pk': 2})
